                    ...
                    <nav className='sidebar-nav'>
                        <ul id='sidebarnav' className='pt-4 in'>
                            <li className='sidebar-item selected'>
                                <Link className='sidebar-link waves-effect waves-dark active' to="/dashboard" aria-expanded="false">
                            ...
                            <li className='sidebar-item selected-2'>
                                <Link to="/" className='sidebar-link waves-effect waves-dark active' >
