...
import PrestadoraCreate from '../../components/prestadoras/PrestadoraCreate';
import Topbar from '../../components/topbar/Topbar';
import Sidebar from '../../components/sidebar/SidebarPrestadoras';

const CriarPrestadora = () => {
    return (
        <div className="body">
                    ...
                    <div className="page-breadcrumb">
                        <div className='row'>
                            <div className='col-5 align-self-center'>
                                <h2 className='page-title'>Cadastrar Prestadora</h2>
                            </div>
                        </div>
                        <div className='row'>
                            <div className='card'>
...
export default CriarPrestadora